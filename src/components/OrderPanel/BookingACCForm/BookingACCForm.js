...
import css from './BookingACCForm.module.css';
...
export const BookingACCFormComponent = props => {
...
BookingACCFormComponent.defaultProps = {
  rootClassName: null,
  className: null,
  price: null,
  isOwnListing: false,
...
BookingACCFormComponent.propTypes = {
...
const BookingACCForm = compose(injectIntl)(BookingDatesFormComponent);
BookingACCForm.displayName = 'BookingDatesForm';

export default BookingACCForm;
